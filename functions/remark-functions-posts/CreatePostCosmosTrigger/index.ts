...
import { ChannelJoinResource, ChannelResource, PostResource, UserResource } from '../lib/model'

const cosmosDBTrigger: AzureFunction = async function (context: Context, documents: PostResource[]): Promise<void> {
